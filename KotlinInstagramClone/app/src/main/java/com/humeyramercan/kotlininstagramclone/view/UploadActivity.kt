...
import com.humeyramercan.kotlininstagramclone.databinding.ActivityUploadBinding
       ...
       if(selectedPicture!=null){
            imageReference.putFile(selectedPicture!!).addOnSuccessListener {
                ...
                uploadPictureReference.downloadUrl.addOnSuccessListener {
                    ...
                    postMap.put("explanation",binding.explanationText.text.toString())
                    postMap.put("date",com.google.firebase.Timestamp.now().toDate())
    ...
    fun selectImage(view:View){
        ...
        if(ContextCompat.checkSelfPermission(this,android.Manifest.permission.READ_EXTERNAL_STORAGE)!=PackageManager.PERMISSION_GRANTED){
            if(ActivityCompat.shouldShowRequestPermissionRationale(this@UploadActivity,android.Manifest.permission.READ_EXTERNAL_STORAGE)){
                Snackbar.make(view,"Permission needed!",Snackbar.LENGTH_INDEFINITE).setAction("Please give permission."){
    ...
    fun registerLauncher(){
        ...
        permissionResultLauncher=registerForActivityResult(ActivityResultContracts.RequestPermission()){ result->
            if(result){
                ...
                //permission denied
                Toast.makeText(this@UploadActivity,"You shoul give permission.",Toast.LENGTH_LONG).show()
            }
        }
    }
}